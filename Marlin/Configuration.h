...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 43.97
    #define DEFAULT_Ki 2.37
    #define DEFAULT_Kd 203.51
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 37.92
  #define DEFAULT_bedKi 1.84
  #define DEFAULT_bedKd 519.82
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN true
